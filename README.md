...
public class Turno {
        ...
        private String dia; // V de instancia= estado almacecnado<-- Atribts son las V que lo guardan       
        // atribts= V de instancia = estado almacenado
        
        public Turno(String dia, int horaInicio, int horaFin) {//accions dl OBJ+Constructor+método ESP    
        // Constructr es el mecanismo qcrea el OBJ y establece su estado inicial.
        ...
        //Turno 1 --> Lunes,9,14; Turno 2 --> Martes, 16,20
